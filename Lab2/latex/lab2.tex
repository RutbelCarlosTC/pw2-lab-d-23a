...
\lstdefinelanguage{CSS}{
  ...
  morestring=[b]",
  morestring=[b]',
  keywords={color, background, font, margin, padding, border, display, position, width, height},
  keywordstyle=\color{blue},
  identifierstyle=\color{black},
  commentstyle=\color{green!60!black},
  stringstyle=\color{purple},
  moredelim=[s][\color{gray}]{[}{]},
  ndkeywords={@import, @media, @font-face},
...
\begin{itemize}
	...
	\begin{figure}[H]
	    \centering
	    \includegraphics[scale=0.6]{img/calculadora.png}
	\end{figure}
	\item Cada vez que se presiona ENTER se guardan los datos involucrados en un pila.
	\item Con memoria y botones para recorrer la pila.
	\item Agregue 4 botones:
	\item M1: memoria
	\item M2: memoria
	\item <-: Moverse para abajo en la pila.
	\item ->:Moverse para arriba en la pila.
...
\subsection{Ejercicio 1}
	...
	\lstinputlisting[language=HTML, caption={banco.html},numbers=left,]{src/banco.html}
...
\subsection{Ejercicio 2}
	\subsubsection{Archivo HTML}
	\lstinputlisting[language=HTML, caption={calculadora.html},numbers=left,]{src/calculadora.html}
	\subsubsection{Archivo CSS}
	\lstinputlisting[language=CSS, caption={estilos.css},numbers=left,]{src/estilos.css}

	\subsubsection{Archivo JS}
	\lstinputlisting[language=JavaScript, caption={script2.js},numbers=left,]{src/script2.js}
