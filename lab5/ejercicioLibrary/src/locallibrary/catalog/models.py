...
class BookInstance(models.Model):
    """Modelo que representa una copia específica de un libro (se puede tomar prestado de la biblioteca)."""
    ...
    @property
    def is_overdue(self):
        """Determina si el libro está vencido según la fecha de vencimiento y la fecha actual."""
