...
class BookInstance(models.Model):
    ...
    copia especifica de un libro (se puede tomar prestado de la biblioteca)."""
    ...
    @property
    def is_overdue(self):
        """Determina si el libro esta vencido segun
          la fecha de vencimiento y la fecha actual."""
